...
BestInPlaceEditor.prototype = {
    ...
    initOptions: function () {
        ...
        self.okButton = self.element.data("bip-okButton") || self.okButton;
        self.okButtonClass = self.element.data("bip-okButtonClass") || self.okButtonClass || BestInPlaceEditor.defaults.okButtonClass;
        self.cancelButton = self.element.data("bip-cancelButton") || self.cancelButton;
        self.cancelButtonClass = self.element.data("bip-cancelButtonClass") || self.cancelButtonClass || BestInPlaceEditor.defaults.cancelButtonClass;
        self.placeHolder = self.element.data("bip-placeholder") || BestInPlaceEditor.defaults.locales[''].placeHolder;
        self.inner_class = self.element.data("bip-innerClass");
        self.html_attrs = self.element.data("bip-htmlAttrs");
        self.original_content = self.element.data("bip-originalContent") || self.original_content;
